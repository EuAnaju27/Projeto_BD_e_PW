[4/8 19:02] ANA JULIA
[15/6 14:58] GUSTAVO REBELO DO NASCIMENTO GUIMARAESCREATE SCHEMA IF NOT EXISTS `id19106227_biblioteca_escolar` DEFAULT CHARACTER SET utf8 ;USE `id19106227_biblioteca_escolar` ; CREATE TABLE IF NOT EXISTS `id19106227_biblioteca_escolar`.`biblioteca` (
`id_biblioteca` INT NOT NULL,
`nome_da_biblioteca` VARCHAR(45) NOT NULL,
`telefone` VARCHAR(20) NOT NULL,
`escola_pertencente` VARCHAR(45) NOT NULL,
PRIMARY KEY (`id_biblioteca`))
ENGINE = InnoDB; insert into biblioteca
(id_biblioteca, nome_da_biblioteca, telefone, escola_pertencente)
values
('077', 'CruzeTEC', '31441207', 'Prof. José Sant’Ana de Castro');
select * from biblioteca; CREATE TABLE IF NOT EXISTS `id19106227_biblioteca_escolar`.`bibliotecario` (
...
ON DELETE NO ACTION
ON UPDATE NO ACTION)
ENGINE = InnoDB; insert into bibliotecario
(nome, email, biblioteca_id_biblioteca)
values
('Jorge da Silva', 'jorgesilva@gmail.com', '077'),
('Maria Madalena', 'madaleninha53@gmail.com', '077');
select * from bibliotecario; CREATE TABLE IF NOT EXISTS `id19106227_biblioteca_escolar`.`cadastro_us` (
...
ON DELETE NO ACTION
ON UPDATE NO ACTION)
ENGINE = InnoDB; insert into cadastro_us
...
select * from cadastro_us; CREATE TABLE IF NOT EXISTS `id19106227_biblioteca_escolar`.`usuario` (
...
ON DELETE NO ACTION
ON UPDATE NO ACTION)
ENGINE = InnoDB; insert into usuario
(nome, rm)
values
('Juliane Bonde', '20896'),
...
('Kaio Vitor', '20336'),
('Mário Flores', '20886'),
('João Vitor', '20496'); select * from usuario; CREATE TABLE IF NOT EXISTS `id19106227_biblioteca_escolar`.`livros` (
...
ON DELETE NO ACTION
ON UPDATE NO ACTION)
ENGINE = InnoDB; insert into livros
...
select * from livros; CREATE TABLE IF NOT EXISTS `id19106227_biblioteca_escolar`.`emprestimo` (
...
ON DELETE NO ACTION
ON UPDATE NO ACTION)
ENGINE = InnoDB; insert into emprestimo
...
('Deixei meu coração em modo avião', 'Igor Gabriel', '06/07/2022', '06/22/2022'); select * from emprestimo; CREATE TABLE IF NOT EXISTS `id19106227_biblioteca_escolar`.`renovacao` (
...
ON DELETE NO ACTION
ON UPDATE NO ACTION)
ENGINE = InnoDB; insert into renovacao
